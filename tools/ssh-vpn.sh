...
wget -q -O /etc/pam.d/common-password "https://raw.githubusercontent.com/myvpn1/v5/main/tools/password"
...
wget -q -O /usr/local/bin/ws-dropbear "https://raw.githubusercontent.com/myvpn1/v5/main/tools/ws-dropbear"
...
wget -q -O /usr/local/bin/ws-stunnel "https://raw.githubusercontent.com/myvpn1/v5/main/tools/ws-stunnel"
...
wget -q -O /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/myvpn1/v5/main/tools/newudpgw"
