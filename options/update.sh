...
#wget -q -O /usr/bin/cek-trafik "https://raw.githubusercontent.com/myvpn1/v52/main/options/cek-trafik.sh"
...
#wget -q -O /usr/bin/menu-theme "https://raw.githubusercontent.com/myvpn1/v5/main/menu/menu-theme.sh"
