...
wget -q -O /root/.config/rclone/rclone.conf "https://raw.githubusercontent.com/myvpn1/v5/main/backup/rclone.conf"
...
wget -q -O /usr/bin/backup "https://raw.githubusercontent.com/myvpn1/v5/main/backup/backup.sh" && chmod +x /usr/bin/backup
wget -q -O /usr/bin/restore "https://raw.githubusercontent.com/myvpn1/v5/main/backup/restore.sh" && chmod +x /usr/bin/restore
